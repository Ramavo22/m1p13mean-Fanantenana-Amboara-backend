...
router.get('/my-product', authenticateToken, authorizeRoles('BOUTIQUE'), (req, res) => productController.myProducts(req, res));

router.get('/:id', (req, res) => productController.getById(req, res));
router.put('/:id', authenticateToken, upload.single('photo'), (req, res) => productController.update(req, res));
router.delete('/:id', authenticateToken, authorizeRoles('BOUTIQUE'), (req, res) => productController.delete(req, res));

// Route to add stock to a product
router.post('/:id/add-stock', authenticateToken, authorizeRoles('BOUTIQUE'), (req, res) => productController.addStock(req, res));
